...
//   const { nodes } = useGLTF('/portal-2.glb')
  useFrame((state, delta) => (backgroundShader.current.time += delta))
  return (
      <mesh>
          <planeBufferGeometry  args={[1, 1, 16, 16]} />
        <backgroundShader ref={backgroundShader} blending={THREE.AdditiveBlending} colorStart="pink" colorEnd="white" />
      </mesh>
